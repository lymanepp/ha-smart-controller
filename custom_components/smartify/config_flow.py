...
class SmartifyControllerConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry: ConfigEntry) -> OptionsFlow:
        ...
        return SmartifyControllerOptionsFlow(config_entry)


class SmartifyControllerOptionsFlow(OptionsFlow):  # type: ignore
    """Handle options."""
