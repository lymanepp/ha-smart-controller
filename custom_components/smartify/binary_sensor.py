...
from .entity import SmartifyControllerEntity
...
async def async_setup_entry(
    ...
    async_add_entities(
        [
            SmartifyControllerBinarySensor(
...
class SmartifyControllerBinarySensor(SmartifyControllerEntity, BinarySensorEntity):
